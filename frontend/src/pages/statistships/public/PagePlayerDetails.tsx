  ...
  return (
    <div className="statistships-welcome-root">
      ...
      <div>
        ...
        <p>
          Red Side Games: {playerStats.gameTotal - playerStats.blueSideTotal}
        </p>
        <p>
          Red Side Wins: {playerStats.winTotal - playerStats.blueSideWinTotal}
        </p>
      ...
      <div>
        <h2>Ratio</h2>
        <p>
          Average KDA : {playerStats.kda[0]} / {playerStats.kda[1]} /{" "}
          {playerStats.kda[2]}
        </p>
        <p>Win Rate: {playerStats.winRate}%</p>
        <p>
          Side Play Rate: {playerStats.blueSidePlayRate}% Blue -{" "}
          {playerStats.redSidePlayRate}% Red
        </p>
        {playerStats.blueSideTotal !== 0 && (
          <p>Blue Side Win Rate: {playerStats.blueSideWinRate}%</p>
        )}
        {playerStats.redSidePlayRate !== 0 && (
          <p>Red Side Win Rate: {playerStats.redSideWinRate}%</p>
        )}
