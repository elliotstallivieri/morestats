...
const RuneRow: React.FC<RuneRowProps> = ({
  ...
  row[0].runeFamily == RuneFamily.StatMods && console.log(selectedRuneId, row[1].id)
      ...
      >
        {row.map((rune) => (
          <Box
            ...
            sx={{
              width: row[0].runeFamily==RuneFamily.StatMods?"10":isKeystone ? (row.length == 3 ? "25%" : "20%") : "12%",
